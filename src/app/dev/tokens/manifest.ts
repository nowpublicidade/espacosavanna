...
export const colorGroups = [
  ...
  },
  {
    ...
    items: [
      ...
      { name: "--fg-muted", hex: "60%", use: "Footer, legendas" },
      { name: "--fg-faint", hex: "45%", use: "Metadados" },
    ],
  },
  {
...
export const typeScale = [
  ...
  { cls: "text-caption text-fg-faint", name: "caption", size: "11.5 → 12.5px", font: "Jost 300", sample: "© 2026 Espaço Savanna" },
